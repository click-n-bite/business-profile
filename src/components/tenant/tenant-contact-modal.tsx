			...
			<div
				...
				<div className='flex-1 overflow-y-auto p-6'>
					<div className='mb-6 text-center'>
						...
						{phone && <p className='mt-2 text-sm text-gray-600 dark:text-gray-400'>Phone: {phone}</p>}
					</div>
				</div>
				...
				<div className='sticky bottom-0 border-t border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900'>
					<div className='grid grid-cols-2 gap-3'>
						<button
							onClick={onClose}
							className='w-full rounded-lg border border-gray-300 px-4 py-3 font-medium transition-colors hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800'>
							{t("buttons.cancel")}
						</button>
						<button
							onClick={() => {
