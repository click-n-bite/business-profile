		...
		<section className='relative overflow-hidden bg-gradient-to-b from-white to-gray-50 py-10 dark:from-[#0c0c0e] dark:via-[#070707] dark:to-[#0c0c0e]'>
			...
			<div className='relative z-10 mx-auto max-w-7xl px-6'>
				<MotionDiv
					...
					<SectionBadge
						icon={Sparkles}
						className='mb-4 inline-flex items-center gap-2 rounded-full border border-[#06bd7a]/30 bg-transparent px-6 py-3 text-emerald-600 dark:text-[#06bd7a]'>
						{t("badge")}
					</SectionBadge>

					<h2 className='mb-6 text-3xl font-bold tracking-tight text-black md:text-4xl dark:text-white'>
						{t("title")}
					</h2>
						...
						{[
							...
							<div key={index} className='group/stat relative'>
								<div className='relative rounded-2xl border border-white/[0.05] bg-white/[0.02] p-6 backdrop-blur-sm'>
									<div className='text-3xl font-bold text-[#06bd7a] dark:text-[#06bd7a]'>{stat.value}</div>
