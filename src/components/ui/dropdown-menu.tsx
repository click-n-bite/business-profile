...
const DropdownMenuItem = ({
	...
	<DropdownMenuPrimitive.Item
		...
		className={cn(
			"focus:text-accent-foreground transition-basic data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10 dark:data-[variant=destructive]:focus:bg-destructive/20 data-[variant=destructive]:focus:text-destructive data-[variant=destructive]:*:[svg]:!text-destructive [&_svg:not([class*='text-'])]:text-muted-foreground relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none focus:bg-gray-100 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:ps-8 dark:focus:bg-gray-800 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
			className
		)}
		{...props}
	/>
...
const DropdownMenuRadioItem = ({
	...
	<DropdownMenuPrimitive.RadioItem
		...
		{...props}>
		<span className='flex-center pointer-events-none absolute start-2 size-3.5'>
			<DropdownMenuPrimitive.ItemIndicator>
