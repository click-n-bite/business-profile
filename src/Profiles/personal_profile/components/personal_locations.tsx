...
export const PersonalLocationCard = ({ title, address, googleMapLink }: PersonalLocationCardProps) => {
	const content = (
		<div className='dark:bg-card/40 dark:bg-card/40 relative mb-4 flex w-full cursor-pointer items-center justify-between rounded-xl border border-slate-200 bg-slate-100 bg-white p-4 text-black transition-all duration-300 hover:-translate-y-1 hover:shadow-lg dark:border-white/5 dark:bg-white/5 dark:text-white'>
