...
export const ContactDepartmentCard = ({
	title,
	phone,
	whatsapp,
	telegram,
				...
				<div className='flex gap-2'>
					{sms && (
						<a
							...
							<Image src='/images/sms.png' alt='SMS' width={20} height={20} className='h-6 w-6' />
						</a>
					)}
					...
					{whatsapp && (
						<a
							...
							<Image src='/images/whatsapp.png' alt='WhatsApp' width={20} height={20} className='h-6 w-6' />
						</a>
					)}
					...
					{telegram && (
						<a
							...
							<Image src='/images/telegram.png' alt='Telegram' width={20} height={20} className='h-6 w-6' />
						</a>
					)}
				</div>
				<div className='flex gap-2'>
					<button
						...
						<Image src='/images/bookmark.png' alt='Save' width={20} height={20} className='h-6 w-6' />
					</button>
					...
					{telephone && (
						<a
							...
							aria-label='Call'>
							<Image src='/images/phone-call.png' alt='Call' width={20} height={20} className='h-6 w-6' />
						</a>
					)}
				</div>
			</div>
