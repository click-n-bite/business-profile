...
import { PartnerCard } from "@/sections/business_profile/components/partners"
			...
			<div ref={emblaRef}>
				<div className='flex'>
					{partners.map((partner, index) => (
						<div key={`${partner.id || "partner"}-${index}`} className='min-w-0 flex-[0_0_50%] px-2 md:flex-[0_0_30%]'>
							<PartnerCard {...partner} />
						</div>
					))}
				</div>
