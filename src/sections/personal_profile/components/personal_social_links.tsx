					...
					<a
						...
						<div className='flex items-center gap-4'>
							<div
								...
								style={{
									backgroundColor: theme?.primaryColor ? `${theme.primaryColor}35` : undefined
								}}>
								<Icon className='h-5 w-5' style={{ color: theme?.primaryColor }} />
							</div>
							<span className='text-lg font-medium text-gray-900 uppercase italic dark:text-white'>{label}</span>
						</div>
